...
body, html {
    ...
    if($result->num_rows>0){
       echo "<br><br>";
        ...
        {
            echo"<tr><td>{$row["C_fname"]}</td><td>{$row["C_lname"]}</td><td>{$row["Vname"]}</td><td>{$row["S_fname"]}</td><td>{$row["S_lname"]}</td><td>{$row["Sale_price"]}</td><td>{$row["Reg_date"]}</td><td>{$row["Del_date"]}</td><td>{$row["Loc_name"]}</td></tr>";
